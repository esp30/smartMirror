        ...
        stage('Deploy on runtime'){
            ...
            steps{
                sshagent(credentials: ['esp30-ssh-deploy']){
                    ...
                    sh "ssh -o 'StrictHostKeyChecking=no' -l esp30 192.168.160.103 docker pull 192.168.160.99:5000/esp30-smartmirror-emotiondetection:latest"
                    sh "ssh -o 'StrictHostKeyChecking=no' -l esp30 192.168.160.103 docker pull 192.168.160.99:5000/esp30-smartmirror-docapp:latest"
